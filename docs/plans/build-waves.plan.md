...
Product half still stands exactly as written. What replaced the retracted claim is NOT "the wave is complete" but
a narrower and still-open list: the `document` → `client` link, and Product. The tenant SETTINGS table, which this

...
| 6 | G3a fiscal research + presets + tax components + tax regimes | L | doing | - | docs/fiscal/** api/config/fiscal/** api/src/Fiscal/** web/src/app/fiscal/** |

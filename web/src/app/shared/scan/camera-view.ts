...
/**
 * This device's camera as a scanner that keeps scanning (docs/SPEC.md § 7, 2026-09-23 09:45, slice 3): the camera's
 * picture, a choice of camera, and each code read the moment it comes into view, with a beep and a buzz as a handheld
 * scanner gives. Where a code goes is the host's: the panel beside a page, or a phone lent to a computer (slice 4).
 */
@Component({
...
export class CameraView implements OnInit {

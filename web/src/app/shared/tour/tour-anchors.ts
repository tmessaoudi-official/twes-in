 ...
 * `data-tour="…"` attribute on a shared component, never on one screen's markup, so a tour step written against
 * « the list's search » keeps working on every list, and a screen redrawn around the same components keeps its tour.
 *

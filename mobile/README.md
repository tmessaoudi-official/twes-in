...
**Scaffolded, not built. The client lands in Wave 11** (`docs/SPEC.md`). Mobile ships first
...
nothing cross-checked them. This tier's rows are under *`mobile/` owed* there.

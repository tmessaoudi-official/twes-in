...
when the tree it applies to genuinely does not exist yet (on 2026-07-29 none of the three stacks does)
— and then **name the dimensions you skipped and why**. A silently skipped dimension is a coverage lie.

- **Money arithmetic (P0).** Amounts are money, not numbers: minor units or a decimal type end to end,

...
/** @implements ProcessorInterface<StockDrawingResource, null> */
final readonly class EraseStockDrawingProcessor implements ProcessorInterface
{
    ...
    public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = []): null
    {
        ...
        try {
            $this->map->eraseDrawing($company, CompanyPath::identifier($uriVariables, 'drawingId'), $this->guard->account()->getId());

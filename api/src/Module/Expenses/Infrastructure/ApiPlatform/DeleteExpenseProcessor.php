...
/** @implements ProcessorInterface<ExpenseResource, null> */
final readonly class DeleteExpenseProcessor implements ProcessorInterface
{
    ...
    public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = []): null
    {
        ...
        try {
            $this->manage->delete($company, CompanyPath::identifier($uriVariables, 'expenseId'), $this->guard->account()->getId());

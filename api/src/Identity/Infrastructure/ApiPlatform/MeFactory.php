...
{
    public function __construct(private UserRepository $users, private DescribeWorkingContext $describeWorkingContext)
    {
    }
    ...
    public function for(SecurityUser $account): Me
    {
        ...
        return Me::of($user, $this->describeWorkingContext->for($user->getId()));
    }
}

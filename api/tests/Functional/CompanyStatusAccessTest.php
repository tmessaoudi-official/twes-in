 ...
 * not a way to learn anything about it. Operators still reach it, which is how they approve it.
 */
final class CompanyStatusAccessTest extends ApiTestCase
{
    ...
    public function testAnOperatorStillReachesAPendingCompany(): void
    {
        $company = $this->pendingCompany();
